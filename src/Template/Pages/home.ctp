        ...
        <div id="url-rewriting-warning" class="alert url-rewriting">
            <ul>
                <li class="bullet problem">
                    ...
                    1) <a target="_blank" href="https://book.cakephp.org/3/en/installation.html#url-rewriting">Help me
                        configure it</a><br/>
                    2) <a target="_blank"
                          href="https://book.cakephp.org/3/en/development/configuration.html#general-configuration">I
    ...
    <div class="columns large-6">
        ...
        <ul>
            ...
            <?php if (!empty($settings)) : ?>
                <li class="bullet success">The <em><?= $settings['className'] ?>Engine</em> is being used for core
                    caching. To change the config edit config/app.php
                </li>
            <?php else : ?>
    ...
    <div class="columns large-6">
        ...
        <ul>
            ...
            <li class="bullet book"><a target="_blank"
                                       href="https://book.cakephp.org/3/en/tutorials-and-examples/cms/installation.html">The
